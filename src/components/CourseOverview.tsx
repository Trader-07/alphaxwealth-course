...
const courses = [
  ...
  },
  {
    ...
    topics: [
      ...
      "Horizontal S&R",
      "Trending S&R",
      "Drawing Trend Lines (Real Example – Bonus 1)",
      "Drawing Horizontal Lines (Real Example – Bonus 2)",
      "Gaps – Gap Analysis (Bonus 3)",
      "Types of Gaps (Bonus 4)",
      "How to Trade Gaps (Bonus 5)",
    ],
  },
  {
    icon: Sparkles,
